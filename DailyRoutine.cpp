...
void mostraAsciiArt(const std::string& nomeArt) {
    std::ofstream file("ascii_command.txt", std::ios::trunc);
    if (file.is_open()) {
        file << nomeArt << std::endl;   // aggiunge un newline per sicurezza
        file.close();
    }
}

void setSfondo(int colore) {
    if (colore < 0 || colore > 15) colore = 0;
    ...
    1,Rosso scuro,bg:1,
    2,Verde scuro,bg:2,
    3,Giallo scuro / Marrone,bg:3,
    4,Blu scuro,bg:4,
    5,Magenta scuro,bg:5,
    6,Ciano scuro,bg:6,
    7,Grigio chiaro,bg:7,
    8,Grigio scuro,bg:8,
    9,Rosso chiaro,bg:9,
    10,Verde chiaro,bg:10,
    11,Giallo chiaro,bg:11,
    12,Blu chiaro,bg:12,
    13,Magenta chiaro,bg:13,
    14,Ciano chiaro,bg:14,
    15,Bianco,bg:15,*/
}
...
|___/ \__ _|_|_|\__  |  \_| \_\___/ \__ _|\__|_|_| |_|\___|
    ...
    system("cls");
    Sleep(200);
    print_slow(cout,"\nRemember to stay connected while plying ( ",30); 
    ...
    Sleep(1500);
    system("cls");
    system("start wt.exe python bg.py");
    ...
    default:{
        SetConsoleTextAttribute(hc, 0x0F);
        print_slow(cout,"\nThe language you selected was not valid\nYou will be redirected to english\n",60);
        Sleep(2500);
        cambiaColoreSfondo(0,15);
        goto label2;
    }
    ...
    label2:
    system("cls"); 
    if(fs::exists("codess.txt")){
        system("del codess.txt");
    }
    if(fs::exists("ascii_command.txt")){
        system("del ascii_command.txt");
    }
    ...
    print_slow(cout,"\nYou open your eyes again,",60);
    mostraAsciiArt("urroom.ansi");
    print_slow(cout," It's morning, You are in your room like every day\n",60);
    Sleep(750);
    print_slow(cout,"Everything around you is in its right place\nThe memories of a dream that was better than reality fade away in your mind\nBut it's time to live now\nWhat do you do?\n\n1)Hop off bed.           2)Stay in.\n\n",50);
    ac = cinBloccato();
    if(ac==1){//Scelta numero: 1
    print_slow(cout,"\nYou wake up and follow your usual routine,\nCoffee, Quick shower with shave,\nYou dress up in a way that makes you appreciate yourself,\nAnd just like that",60);
    mostraAsciiArt("house.ansi");
    print_slow(cout," you are ready to crush the day\nYou exit your boring apartment and surf the streets\nWhat's the next move\n\n1)Go to work           2)Get around\n\n",55);
    xxx = cinBloccato();
    if(xxx==1){//Scelta numero: 1.1
        print_slow(cout,"\nYou know what you gotta do,\nIf you don't go to work is gon'be a problem for future you\nAnd you don't want that at all\n\nSo you take your car and go to work like every day\n",60);
        Sleep(500);
        print_slow(cout,"\nYou park near the building, grab your bag and walk to the elevator\nClocking in you notice pam is not in the reception since she arrives after everybody\n",60);
        Sleep(750);
        mostraAsciiArt("office.ansi");
        print_slow(cout,"\nOnce in the office you greet your coworkers and go to your set-up\nThese gray walls make you feel a little dead inside\nYou don't even start working that you notice two SMS\n",60);
        mostraAsciiArt("AoB.ansi");
        Sleep(800);
        print_slow(cout,"\nOne's from a girl, She's really into you and you are too,\nShe's asking if you want to go to dinner,\n",60);
        Sleep(500);
        ...
        if(b==1){//Scelta numero: 1.1.1
            print_slow(cout,"\nYou don't wanna be rude to your boss,\nEven tho you don't really like him,\nBut sometimes it's better to prioritize personal life before the business one,\nYou're not sure tho,\n\nWill you accept\n\n1)Accept.           2)Decline.\n\n",55);
            c=cinBloccato();
            if(c==1){//Scelta numero: 1.1.1.1
                ...
                print_slow(cout,"\n-Sure, i know a good restaurant\n",50);
                SetConsoleTextAttribute(hc, 0x70);
                print_slow(cout,"\nShe accepts right away\n'This is the right time' you think between yourself\n",60);
                mostraAsciiArt("setup.ansi");
                Sleep(1000);
                print_slow(cout,"\nAs you keep working with a satisfied look on your face you wait for the work-day to end.\nWork is normal, not too exciting but it doesn't make you wanna die either\nA few hours pass and it's basically time to clock out\nYou usually clock out early at 15:30\n",60);
                Sleep(750);
                print_slow(cout,"\nAfter work is done you come back to your car and find a rather not cool surprise\nYour car door on the driver side has been totally scratched\n",60);
                mostraAsciiArt("side.ansi");
                Sleep(500);
                print_slow(cout,"\nAnd if that didn't suck enough you hear a girl laugh in the distance of the parking lot\n",60);
                Sleep(200);
                print_slow(cout,"\nWho the fuck even was she\nAnyway you direct yourself home and park in the garage\nYou'll bring the car to the mechanic tomorrow, today you don't have time\nYou made it home at about 16 so you have plenty time\n",60);
                mostraAsciiArt("tv.ansi");
                Sleep(750);
                print_slow(cout,"\nYou go take a shower and watch some tv after\nTime flies as usual, after getting dressed you're ready to hang out\n",60);
                mostraAsciiArt("walk.ansi");
                ...
                Sleep(300);
                print_slow(cout,"\nAnd with that a thought also occurs in your head\n",60);
                Sleep(840);
                SetConsoleTextAttribute(hc, 0x78);
                ...
                if(ae==1){//Scelta numero: 1.1.1.1.1
                    SetConsoleTextAttribute(hc, 0x70);
                    print_slow(cout,"\nYou stand up from the bench and walk up to her\n",60);
                    Sleep(400);
                    SetConsoleTextAttribute(hc, 0x78);
                    print_slow(cout,"\n-Hey are you Ashley?\n",40);
                    mostraAsciiArt("ash.ansi");
                    Sleep (500);
                    SetConsoleTextAttribute(hc, 0x74);
                    print_slow(cout,"\n-Yes, and you must be ",60);
                    cout<<nome<<endl;
                    Sleep (500);
                    SetConsoleTextAttribute(hc, 0x70);
                    ...
                    Sleep(500);
                    SetConsoleTextAttribute(hc, 0x70);
                    print_slow(cout,"\nShe is wearing a white shift dress with long black pants,\nLong blond hair probably sun-kissed\nYou look into her sky blue eyes for a few seconds\nYou realize that it is better to be nonchalant about the work thing",60);
                    SetConsoleTextAttribute(hc, 0x78);
                    ...
                    PlaySound(TEXT("./music/JAZZY.wav"), NULL, SND_FILENAME | SND_ASYNC );
                    Sleep(500);
                    SetConsoleTextAttribute(hc, 0x70);
                    print_slow(cout,"\nAfter a few funny looks the waiter welcomes you and seats you\n",60);
                    mostraAsciiArt("ashres.ansi");
                    print_slow(cout,"\nYou order a Cheesesteak, She goes for something made of salad, you didn't really understand\nAnd in a second you guys start talking like you are friends\n",55);
                    Sleep(500);
                    SetConsoleTextAttribute(hc, 0x78);
                    print_slow(cout,"\n-I have to break it down at the start,\n",38);
                    Sleep(500);
                    print_slow(cout,"-Do you do karate, saw some pictures on your account, the gym seems really similar to the one i used to go\n",36);
                    Sleep(500);
                    SetConsoleTextAttribute(hc, 0x74);
                    ...
                    Sleep (500);
                    SetConsoleTextAttribute(hc, 0x74);
                    print_slow(cout,"\n-You kidding? That would be awesome, Like a thought less\n",35);
                    Sleep (500);
                    SetConsoleTextAttribute(hc, 0x78);
                    print_slow(cout,"\n-Yeah That's what im sayn' like so much cheap\n",34);
                    Sleep (500);
                    SetConsoleTextAttribute(hc, 0x70);
                    print_slow(cout,"\nAnd that went on...\n",60);
                    Sleep (500);
                    ...
                    Sleep(300);
                    SetConsoleTextAttribute(hc, 0x74);
                    print_slow(cout,"\n-OH, I Could walk the whole earth if i wanted to\n",40);
                    Sleep(200);
                    SetConsoleTextAttribute(hc, 0x78);
                    print_slow(cout,"\n-WHAT?\n",40);
                    Sleep(600);
                    ...
                    print_slow(cout,"\n*Both Laugh*\n",50);
                    Sleep(500);
                    print_slow(cout,"It was about 0:27am that you realized\n",60);
                    SetConsoleTextAttribute(hc, 0x78);
                    ...
                    Sleep (500);
                    SetConsoleTextAttribute(hc, 0x78);
                    print_slow(cout,"\n-Yeah we wake up at the same time...\n",68);
                    SetConsoleTextAttribute(hc, 0x70);
                    print_slow(cout,"\nShe smiles in a funny way\nYou both stand up and go to the exit\n",60);
                    PlaySound(TEXT("./music/GNM.wav"), NULL, SND_FILENAME | SND_ASYNC | SND_LOOP);
                    mostraAsciiArt("ash.ansi");
                    Sleep(1000);
                    print_slow(cout,"\nOnce outside your eyes meet once again\nYou give each other a warm hug\n",60);
                    SetConsoleTextAttribute(hc, 0x74);
                    Sleep(400),
                    print_slow(cout,"\n-Wanna walk together?\n",38);
                    Sleep(200);
                    ...
                    SetConsoleTextAttribute(hc, 0x78);
                    Sleep(300);
                    print_slow(cout,"\n-Sure why not, since i've no car cause someone scratched it n'shit today..\n",38);
                    SetConsoleTextAttribute(hc, 0x74);
                    Sleep(500);
                    ...
                    if(ag==1){//Scelta numero: 1.1.1.1.1.1
                        ...
                        Sleep(500);
                        SetConsoleTextAttribute(hc, 0x70);
                        print_slow(cout,"\nYou both smile cause you know what's gonna happen\nYou two are actually pretty\nThere is a ton of feeling between you two\nYou take a look at her house from outside\nWow she must be getting paid more than you\nHer place is lovely, the living room is big, white walls and wooden furniture\nOh and a huge red soft carpet and couch\nShe has a lot of weird decoration that match the like samurai, old japan aesthetic\nWhile you're admiring her DVD collection she locks the door behind you\n",60);
                        Sleep(500);
                        mostraAsciiArt("saloonash.ansi");
                        ...
                        PlaySound(TEXT("./music/FB.wav"), NULL, SND_FILENAME | SND_ASYNC );
                        setSfondo(15);
                        Sleep(35);
                        setSfondo(0);
                        Sleep(1000);
                        print_slow(cout,"You hear a loud bang\nAshley immediately jumps on her feet, you turn your head to see\n",60);
                        PlaySound(TEXT("./music/LSC.wav"), NULL, SND_FILENAME | SND_ASYNC | SND_LOOP);
                        mostraAsciiArt("lennyaura.ansi");
                        print_slow(cout,"\nSomeone blow up the door, There is a woman with a black suit in the living room\nShe has a fucking sword.\n",42);
                        SetConsoleTextAttribute(hc, 0x78);
                        Sleep(500);
                        print_slow(cout,"\n-WHAT THE FUCK\n",28);
                        SetConsoleTextAttribute(hc, 0x70);
                        print_slow(cout,"\nAshley reaches for a Katana on the wall\nThey start fighting\n",60);
                        SetConsoleTextAttribute(hc, 0x74);
                        Sleep (200);
                        cout<<"\n-"<<nome;
                        print_slow(cout," YOU HAVE TO GET OUT\n",41);
                        Sleep(500);
                        SetConsoleTextAttribute(hc, 0x72);
                        print_slow(cout,"\n-Oh bebe, ",60);
                        cout<<nome;
                        print_slow(cout," will never be yours, he's not real enough\n",45);
                        SetConsoleTextAttribute(hc, 0x74);
                        Sleep (500);
                        print_slow(cout,"\n-LEAVE US ALONE\n",30);
                        SetConsoleTextAttribute(hc, 0x72);
                    ...
                    else{//Scelta numero: 1.1.1.1.1.2
                        SetConsoleTextAttribute(hc, 0x78);
                    ...
                    Sleep(300);
                    print_slow(cout,"\nInside there are few people and the place is not even well light up,\nYou sit at the counter shoulder to the exit\nNot much to say about the whole place either, empty other than the bar itself,\nSome alcohol behind the counter, the bartender in front of me looks sad as he dries the glasses with a towel\nThere are also a few slot machines in the corner making some lights,\n",60);
                    SetConsoleTextAttribute(hc, 0x78);
                    Sleep(400);
                    print_slow(cout,"\n-WELL, looks like tonight is between us boys!\n",40);
                    Sleep(750);
                    SetConsoleTextAttribute(hc, 0x70);
                    print_slow(cout,"\nAfter that you just hear cough echoing through the place\nNo one really vibes with you\nYou just exchange eye contact with the guy sitting beside you\n",60);
                    Sleep(750);
                    print_slow(cout,"\n1)Grab a drink           2)'Make some noise'\n",60);
                    qq=cinBloccato();
                    if(qq==1){//Scelta numero: 1.1.1.1.2.1
                        //prendi il drink e quello accanto ci sta il padre i alice ti da la cartella in cui stanno dei file corpo in cui si palra di lore e lenny 
                    }
                    else{//Scelta numero: 1.1.1.1.2.2
                        //a bbudffo tiri fuiri le armi e pari alla gente fra cui ash, lenny ti ferma e torni al loop
                    }
                }
            }
            else{//Scelta numero: 1.1.1.2
                print_slow(cout,"\nFor how much into her you can be\nYou don't really feel like going out with her\nSo you rethink asking your bro for a beer\n",60);
                mostraAsciiArt("setup");
                Sleep(750);
                ...
                mostraAsciiArt("alice.ansi");
                print_slow(cout,"\nThere is a fairly short girl in front of you\nAs soon as she sees you she just sort of paralyzes,\nShe's dressed in an unusual way for an office, gray hoodie, black baggy jeans and some chains\nShe has a box cutter in her hand,\nA line of blood drips from her wrist on the floor\n\n1)Try to calm her down             2)Join her\n\n",60);
                n=cinBloccato();
                if(n==1){//Scelta numero: //Scelta numero: 1.1.1.2.1
                    ...
                    Sleep(400);
                    SetConsoleTextAttribute(hc, 0x70);
                    print_slow(cout,"\nAfter that she looks at you for a couple seconds with an expression between a surprised and a laugh\nHer stare feels like she's been going insane, she keeps looking at you immovable\nHer look starts to become more analytic, like she hadn't seen a human in years\n",60);
                    Sleep(300);
                    SetConsoleTextAttribute(hc, 0x75);
                    print_slow(cout,"\n-em..",45);
                    Sleep(400);
                ...
                if(af==1){//Scelta numero: 1.1.1.2.1.1
                    ...
                    SetConsoleTextAttribute(hc, 0x75);
                    print_slow(cout,"\n-HAHAHAH AND YOU WROTE THIS?!\n",38);
                    Sleep(230);
                    print_slow(cout,"-IT LOOKS LIKE IT'S FROM A 10-YEAR-OLD HAHAHAHAH\n",38);
                    Sleep(100);
                    SetConsoleTextAttribute(hc, 0x70);
                    ...
                    mostraAsciiArt("bathroom.ansi");
                    print_slow(cout,"Classic mood-swings you see in a depressed person\nWell at least even if the note was shitty you",60);
                    Sleep(200);
                    print_slow(cout," ...",100);
                    ...
                    if(jj==1){//Scelta numero: 1.1.1.2.1.1.1
                        ...
                        Sleep(110);
                        print_slow(cout,"you have no clue how much i need this more than you do",48);
                        Sleep(500);
                        ...
                        if(gg==1){//Scelta numero: 1.1.1.2.1.1.1.1
                            ...
                            SetConsoleTextAttribute(hc, 0x78);
                            print_slow(cout,"\n-At least im glad im not the only one smoking in this office\n",55);
                            Sleep(400);
                            SetConsoleTextAttribute(hc, 0x75);
                        ...
                        else{//Scelta numero: 1.1.1.2.1.1.1.2
                            ...
                            Sleep(220);
                            print_slow(cout,"\nHer clothes are already ripped so you don't really mind and start walking in the opposite direction back into the office\n",60);
                            Sleep(500);
                            SetConsoleTextAttribute(hc, 0x75);
                            ...
                            if (codess == "32718") {//Scelta numero: 1.1.1.2.1.1.1.2
                                remove("codess.txt");
                                ...
                                Sleep(750);
                                print_slow(cout,"\n-Ugh yes while you're here you get to take a look at my locker",55);
                                Sleep(500);
                            ...
                            else{//Scelta numero: 1.1.1.2.1.1.1.2.N
                                remove("codess.txt");
                                SetConsoleTextAttribute(hc, 0x70);
                                print_slow(cout,"\nAnd that's wrong\nYour fingers shake for a moment\nYou look at alice",60);
                                if(alice == true){
                                    print_slow(cout,"\nYou remember this girl\nYou remember seeing her in room?\nShe killed you\nThat was probably a dream tho\n",60);
                                    Sleep(500);
                                    print_slow(cout,"\nIt wouldn't hurt to ask\n",60);
                                    SetConsoleTextAttribute(hc, 0x78);
                                    print_slow(cout,"\n-Hey ..ahem Alice, if i may ask\n-What were you doing that made you so anxious back in that room?\n",60);
                                    Sleep(500);
                                    SetConsoleTextAttribute(hc, 0x70);
                                    print_slow(cout,"\nShe puts her hand in front of her mouth in a goofy attempt to hide her laugh\n",60);
                                    Sleep(250);
                                    print_slow(cout,"\nThen proceeds\n",60);
                                    SetConsoleTextAttribute(hc, 0x75);
                                    print_slow(cout,"\n-You don't remember the code but you definitely remember that huh\n",60);
                                    Sleep(200);
                                    SetConsoleTextAttribute(hc, 0x78);
                                    print_slow(cout,"-\nYeah..",60);
                                    Sleep(100);
                                    ...
                                    Sleep(750);
                                    SetConsoleTextAttribute(hc, 0x70);
                                    print_slow(cout,"\n-Alice comes close to your chest looking at you\n",60);
                                    Sleep(130);
                                    SetConsoleTextAttribute(hc, 0x75);
                                    print_slow(cout,"\n-I was fucking with things\n",52);
                                    Sleep(50); 
                                    SetConsoleTextAttribute(hc, 0x70);
                                    print_slow(cout,"\nNow you're the one holding his laugh\n",60);
                                    Sleep(50);
                                    SetConsoleTextAttribute(hc, 0x78);
                                    print_slow(cout,"\n-Wait in what sense?\n",50);
                                    Sleep(55);
                                    SetConsoleTextAttribute(hc, 0x75);
                                    print_slow(cout,"\n-In the sense you ",60);
                                    print_slow(cout,"SHOULD MIND YOUR FUCKING BUSINESS\n",40);
                                    Sleep(750);
                                    SetConsoleTextAttribute(hc, 0x70);
                                    print_slow(cout,"\nAlice leaves the room without adding anything else\nThis leaves you a little upset\n",60);
                                    Sleep(300);
                                    print_slow(cout,"\nThis girl always acts like she has something going on\nComing up with bits like she's in a sitcom\nNever really going anywhere\n",60);
                                    Sleep(1000);
                                    SetConsoleTextAttribute(hc, 0x78);
                                    print_slow(cout,"\n-Whatever.",50);
                                    Sleep(750);
                                    print_slow(cout,"\n-What a weird girl",50);
                                }
                                Sleep(400);
                                SetConsoleTextAttribute(hc, 0x78);
                                print_slow(cout,"\n-See no luck with your code",50);
                                Sleep(1000);            
                                //dafinire
                    ...
                    else{//Scelta numero: 1.1.1.2.1.1.2
                        print_slow(cout,"\nYou think is too much to do drugs during the work hours\nWalking back to the desks you notice that girl it's not of the same idea,",60);
                        mostraAsciiArt("alices.ansi");
                        print_slow(cout,"\nYou see her smoking outside on the office balcony\nShe looks focused but at the same time her stare looks empty,\nWho knows what she might be thinking\n",60);
                        Sleep(1000);
                        print_slow(cout,"\n1)Go talk to her         2)Ignore her",60);
                        ad=cinBloccato();
                        if(ad==1){//Scelta numero: 1.1.1.2.1.1.2.1
                            SetConsoleTextAttribute(hc, 0x78);
                            print_slow(cout,"\n-Tsk, why not\n",40);
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nYou stand up and go to the break room",60);
                            mostraAsciiArt("broomdoor.ansi");
                            Sleep(600);
                            print_slow(cout,"\nThere you grab a galss of water\n",60);
                            Sleep(300);
                            print_slow(cout,"\nYou step through the door that leads to the balcony",60);
                            Sleep(500);
                            print_slow(cout,"\nOr at least you try to since it seems to be locket\nYou try pushing\nPulling\nKnoking\nNoting works\n",60);
                            Sleep(750);
                            print_slow(cout,"\nYou can even see her outside\nBut it's like she can't see you\n",60);
                            Sleep(200);
                            SetConsoleTextAttribute(hc, 0x78);
                            print_slow(cout,"\n-Oh well, i tried\n",45);
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nYou still want to talk to someone though\nPam should have clocked in by now\nLet's go check on her\n",60);
                            Sleep(1000);
                            mostraAsciiArt("elev.ansi");
                            Sleep(3000);
                            print_slow(cout,"\n\n\n\n\n",300);
                            PlaySound(TEXT("./music/EDGE.wav"), NULL, SND_FILENAME | SND_ASYNC | SND_LOOP);
                            Sleep(200);
                            print_slow(cout,"\nAfter a moment the doors open\n",60);
                            mostraAsciiArt("recepc.ansi");
                            print_slow(cout,"\nRight away you notice something\nOutside is way darker\nLooks like it started raining\nYou haven't been in the elevetor that long\n",60);
                            Sleep(500);
                            print_slow(cout,"\nThe room is weirdly quiet, not even the usual typing\nPam does not greet you with her look like she usualy does\nYou can't even really see her at the desk\n",60);
                            Sleep(500);
                            print_slow(cout,"\nSo you walk to her desk\n",60);
                            Sleep(200);
                            mostraAsciiArt("manichino ciotto.ansi");
                            Sleep(600);
                            SetConsoleTextAttribute(hc, 0x78);
                            print_slow(cout,"\n-GOD WHAT\n",44);
                            Sleep(60);
                            ...
                            print_slow(cout,"\nYou got startled",60);
                            Sleep(200);
                            print_slow(cout,"\nIt's just a mannequin\nMore like a crash dummy actually\nYou feel this as being less important than what is going on right now\n",60);
                            Sleep(340);
                            print_slow(cout,"\nYou go take a peek at the window",60);
                            mostraAsciiArt("rain.ansi");
                            print_slow(cout,"\nEverything as usual\nExept the rain of curse, and\n",60);
                            SetConsoleTextAttribute(hc, 0x78);
                            print_slow(cout,"\n-Hmm again?\n",60);
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nAlso those doors are locked\nYou start feeling nervous\nIs someone planning something\nMaybe a terrorist attack\nWhat if ",60);
                            Sleep(400);
                            print_slow(cout,"\nYou feel a slight tap on your shoulder\n",60);
                            Sleep(600);
                            print_slow(cout,"\nYou hesitate just to turn around at some point and",60);
                            PlaySound(TEXT("./music/spook.wav"), NULL, SND_FILENAME | SND_ASYNC );
                            mostraAsciiArt("creepy.ansi");
                            Sleep(7000);
                            system("cls");
                            setSfondo(0);
                            cambiaColoreSfondo(0,15);
                            ...
                            std::this_thread::sleep_for(std::chrono::milliseconds(50));}
                            goto label2;
                            //provi a raggiungere alice ma non trovi porte per uscire/ la prota e' chiusa e poi vai a parlare a pam ma e' tipo un manichino e a una certa restarti perche era tipo un sogno
                        }
                        else{//Scelta numero: 1.1.1.2.1.1.2.2
                            print_slow(cout,"\nTo a degree though,\nYou don't really care about her",60);
                            mostraAsciiArt("setup.ansi");
                            Sleep(500);
                            print_slow(cout,"\nYou work for about an hour then get bored of it\nUsually when you get bored at work there is one thing you always do\n",60);
                            Sleep(750);
                            mostraAsciiArt("elev.ansi");
                            print_slow(cout,"\nYou go down to the reception where Pam always sits\nYou two always got along but never have time to bond",60);
                            mostraAsciiArt("pam.ansi");
                            SetConsoleTextAttribute(hc, 0x78);
                            print_slow(cout,"\n-Yoo pam how are you?\n\n",47);
                            Sleep(100);
                            ...
                            print_slow(cout,"\n-Heyyy ",50);
                            cout<<nome;
                            print_slow(cout," im really glad to see you,\n-Im doing fine thanks\n-How about you darling?\n",42);
                            Sleep(50);
                            SetConsoleTextAttribute(hc, 0x78);
                            print_slow(cout,"\n-Perfectly fine now that i see you\n",40);
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nYou flirty fuck\n",60);
                            SetConsoleTextAttribute(hc, 0x7E);
                            print_slow(cout,"\n-Aw you silly",50);
                            Sleep(800);
                            print_slow(cout,"\n-Tell me are you still into that social research thing?\n",45);
                            Sleep(300);
                            SetConsoleTextAttribute(hc, 0x78);
                            print_slow(cout,"\n-Yeah on and off",44);
                            Sleep(400);
                            print_slow(cout,"\n-I like to think a version of me somewhere already completed it\n",50);
                            Sleep(500);
                            SetConsoleTextAttribute(hc, 0x7E);
                            print_slow(cout,"\n-What a great way to justify your laziness\n",51);
                            SetConsoleTextAttribute(hc, 0x78);
                            print_slow(cout,"\n-Yeah probably you are right",50);
                            Sleep(500);
                            print_slow(cout,"\n-But still these days i have better things to think about\n",55);
                            Sleep(200);
                            SetConsoleTextAttribute(hc, 0x7E);
                            print_slow(cout,"\n-Like what?\n",63);
                            Sleep(1000);
                            ...
                            Sleep(150);
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nYou hear a lout sound to your right\nYou turn to see aa cascade of glass falling onto the floor",60);
                            mostraAsciiArt("joshh.ansi");
                            print_slow(cout,"\nPam screams beside you\nA drunk middle-aged man has broke through the front glass door\n",60);
                            Sleep(800);
                            print_slow(cout,"\nAfter another look you realize you know that guy,\nHe's called Josh, you haven't seen him in a while\nYou didn't expect your next meeting to be like this,\nYou hear a walkie-talkie click.\n",60);
                            Sleep(100);
                            SetConsoleTextAttribute(hc, 0x7E);
                            print_slow(cout,"\n-Security we have a 10-15\nShirtless male, has a gun",33);
                            Sleep(500);
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nYou feel kinda tense so you start backing up,\nThe guy's shoulder is bleeding\nWhat the fuck is happening in his life?\nHas he gone insane?\n",60);
                            Sleep(600);
                            print_slow(cout,"\nYour goofy attempt to hide just makes him notice you\nHe screams\n",60);
                            Sleep(120);
                            SetConsoleTextAttribute(hc, 0x79);
                            for (char& c : nome) c = toupper(static_cast<unsigned char>(c));
                            cout << "\n-" << nome << endl;
                            Sleep(100);
                            print_slow(cout,"-YOU ARE SO DONE\n",40);
                            print_slow(cout,"\n-COME HERE\n",12);
                            Sleep(450);
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nYou're not the only one with the good sight\nHe's coming straigth for you\n",60);
                            Sleep(200);
                            SetConsoleTextAttribute(hc, 0x78);
                            print_slow(cout,"\n-WAIT Josh why are you doing this?\n-We can talk this out i swear i-\n",34);
                            setSfondo(0);
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nA punch strikes your face and makes you fall\n",60);
                            Sleep(175);
                            mostraAsciiArt("joshi.ansi");
                            print_slow(cout,"\nYou open your eyes just to see Josh furious with an insane look in his eyes\n",60);
                            Sleep(60);
                            SetConsoleTextAttribute(hc, 0x79);
                            print_slow(cout,"\n-FIRST YOU DON'T WANT TO HANG WITH ME\n",28);
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nWhat is he talking about?\nWhy now?\n",60);
                            SetConsoleTextAttribute(hc, 0x79);
                            print_slow(cout,"\n-THEN YOU FORCE ME TO DO THIS",30);
                            Sleep(100);
                            print_slow(cout,"\n-WHY ",10);
                            for (char& c : nome) c = toupper(static_cast<unsigned char>(c));
                            cout << "\n-" << nome << endl;
                            ...
                            print_slow(cout,"\n-WHY?\n",30);
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nJosh starts bashing your head ",60);
                            setSfondo(0);
                            print_slow(cout,"on the floor\nYou feel your skull craking with every hit\nThe noise in your head is loud\nBut you can distinctly hear heavy steps\nFollowed by gun shots\nThen silence\n",60);
                            Sleep(3000);
                            print_slow(cout,"\nYou really feel like taking a nap but you can't quite grasp why\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",60);
                            cambiaColoreSfondo(0,15);
                            system("cls");
                            for (int i = 0; i <= total; ++i) {
                            displayProgressBar(i, total);
                ...
                else{//Scelta numero: 1.1.1.2.1.2
                    Sleep(500);
                    ...
                    SetConsoleTextAttribute(hc, 0x70);
                    print_slow(cout,"\nShe comes close to you, looks at you deeply in the eyes and kisses you on the mouth\nThat mix of unexpected and weird situation almost turns you on\n",50);
                    SetConsoleTextAttribute(hc, 0x75);
                    ...
                    SetConsoleTextAttribute(hc, 0x70);
                    Sleep(2500);
                    print_slow(cout,"\nShe says while she slips an hand in your pocket where the knife was before leaving the bathroom",60);
                    mostraAsciiArt("bathroom.ansi");
                    print_slow(cout,"\nIt's a business card\n",60);
                    system("start https://drive.google.com/file/d/1kYYg9w460Ac6errImD81KVI1qLsGK_PY/view?usp=sharing");
                    Sleep(8000);
                    ...
                    if(o==1){//Scelta numero: 1.1.1.2.2.1
                        ...
                        Sleep(750);
                        print_slow(cout,"\nYour view is still a little blurry but you remember about her\n",60);
                        Sleep(500);
                        print_slow(cout,"You decide to go on the roof to savor a little of the night breeze\nYou take the elevator to the R floor\n",60);
                        mostraAsciiArt("elev.ansi");
                        Sleep(400);
                        ...
                        Sleep(750);
                        SetConsoleTextAttribute(hc, 0x70);
                        print_slow(cout,"\nYour legs feel heavy during the rise\nThe silence makes you hear everything\nThe electricity going through the muted speakers\nThe weight pulling the elevator up and the cabin surfing the wire\nAnd then it stops\nAnd the door opens\n",60);
                        Sleep(1200);
                        print_slow(cout,"\nYou walk out almost surprised to see the roof",60);
                        mostraAsciiArt("roof.ansi");
                        ...
                        if(r==1){//Scelta numero: 1.1.1.2.2.1.1
                        ...
                        else{//Scelta numero: 1.1.1.2.2.1.2
                            ...
                            Sleep(500);
                            print_slow(cout,"\nWhile lost in the train of thoughts,\nYou see a person in the middle of the street near a light pole\nJust a few meters before your condo\n",60);
                            mostraAsciiArt("sus.ansi");
                            print_slow(cout,"\nIt's just standing there, feels kind of weird but you will have to walk past it,\n",60);
                            Sleep(500);
                            print_slow(cout,"\nYou take a breath and speed up your pace\nShe seems a female figure, dressed with a black work suit\nReally elegant for someone just wondering the night\n",60);
                            Sleep(500);
                            print_slow(cout,"\nAs you pass beside her you see that her gaze is following you",60);
                            Sleep(750);
                            print_slow(cout,"\nEven after you surpassed her she is still staring at you with a disturbingly neutral expression\n",60);
                            Sleep(1000);
                            print_slow(cout,"\nYou lock your door behind you,\nYou're safe now, in the comfort of your house\nYou head to your room and collapse on the bed",60);
                            mostraAsciiArt("roomn.ansi");
                            Sleep(500);
                            print_slow(cout,"\nYou still can't shake the thought of how hard you fucked up today\nYou don't even want to think about it or else you will start crying\n",60);
                            Sleep(1000);
                            SetConsoleTextAttribute(hc, 0x78);
                            print_slow(cout,"\n-...\n",80);
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nSlowly your eyelids slide close",60);
                            Sleep(2500);
                            system("cls");
                            cambiaColoreSfondo(0,15);
                            setSfondo(0);
                    ...
                    else{//Scelta numero: 1.1.1.2.2.2
                        ...
                        if(p==1){//Scelta numero: 1.1.1.2.2.2.1
                            print_slow(cout,"\nYou type the number on your phone,\nAfter a few rings she picks up the line\n\n . . .\n",60);
                            SetConsoleTextAttribute(hc, 0x75);
                            print_slow(cout,"\n-Hello\n",80);
                            Sleep(300);
                            SetConsoleTextAttribute(hc, 0x78);
                            ...
                            if(al==1){//Scelta numero: 1.1.1.2.2.2.1.1
                                ...
                                Sleep(1000);
                                SetConsoleTextAttribute(hc, 0x75);
                                print_slow(cout,"\n-I'm tired of plying in something i didn't agree to\n",50);
                                Sleep(400);
                                SetConsoleTextAttribute(hc, 0x70);
                                print_slow(cout,"\nShe is paranoid tho\n",60);
                                Sleep(750);
                            ...
                            else{//Scelta numero: 1.1.1.2.2.2.1.2
                        ...
                        else{//Scelta numero: 1.1.1.2.2.2.2
            ...
            if(g==1){//Scelta numero: 1.1.2.1
                ...
                if(l==1){//Scelta numero: 1.1.2.1.1
                    ...
                    if(aa==1){//Scelta numero: 1.1.2.1.1.1
                        ...
                        SetConsoleTextAttribute(hc, 0x78);
                        print_slow(cout,"\n-Oh you know the usual other than a few weird phone calls\n",50);
                        Sleep(2000);
                        ...
                        Sleep(1500);
                        SetConsoleTextAttribute(hc, 0x70);
                        print_slow(cout,"\nYou walk away from Pam's desk and outside of the building\nAt the moment you really have nothing better to do\nAnd having these coordinates makes you feel a little less lost\nYou still can't make up to yourself how weird this is\nBut at the same time you've always been a fan of these kinds of treasure hunts\nBut why should i be the one to have chosen to participate\nYou arrive to the car",60);
                        Sleep(1200);
                        ...
                        else{//Scelta numero: 1.1.2.1.1.2.2
                            //dafinire
                        }
                    }
                }
                else{//Scelta numero: 1.1.2.1.2
                    ...
                    if(ab==1){//Scelta numero: 1.1.2.1.2.1
                        ...
                        if(aq==1){//Scelta numero: 1.1.2.1.2.2.1
                            ...
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nThe statue just evaporated in front of you eyes\nIn doing so it emitted a bright light your eyes couldn't stand\nWhat was left behind other than smoke in the room,\nWas the liquid you heard from inside the Replica",60);
                            //dafninire
                        }
                    }
                }
            }
            else{//Scelta numero: 1.1.2.2
                PlaySound(TEXT("./music/BT.wav"), NULL, SND_FILENAME | SND_ASYNC | SND_LOOP);
                print_slow(cout,"\nThe frustration of the whole month flows through your blood and makes it boil\nYour boss is there in front of you looking directly in your eyes\nAlmost smiling\nYou look back at him and laugh\n",60);
                Sleep(750);
                print_slow(cout,"\nYou start picking up random objects from his desk and throwing them at him\nSeeing the stapler hitting his forehead was so satisfying\nUntil, blinded by rage you accidentally throw the paper cutter,\nDirectly at his face\n",60);
                Sleep(750);
                mostraAsciiArt("bossh.ansi");
                ...
                if(m==1){//Scelta numero: 1.1.2.2.1
                    ...
                    if(as==1){//Scelta numero: 1.1.2.2.1.1
                        ...
                        //oppure mi pare che alfredo mi ha cosnigliato che si ribella e ti spacca il culo 
                        //dafinire
                    }
                        ...
                        SetConsoleTextAttribute(hc, 0x7D);
                        cout<<"\n-"<<nome;
                        print_slow(cout," you never call me, specially this early in the morning\n",54);
                        Sleep(80);
                        ...
                        SetConsoleTextAttribute(hc, 0x70);
                        Sleep(400);
                        print_slow(cout,"\nYou start getting a little anxious\n",60);
                        SetConsoleTextAttribute(hc, 0x78);
                        ...
                        Sleep(500);
                        SetConsoleTextAttribute(hc, 0x70);
                        print_slow(cout,"\nSeconds later the letter arrives\n",60);
                        ...
                        exit(0);
                            ...
                            print_slow(cout,"\nYour heart beats out of your chest,\nYou've never been in such a situation\nYou feel trapped by this office\nYou don't want to come out of it anymore\nMaybe hell won't be so cruel if you don't bring someone with you\n\nYou put the gun barrel on your head and press the trigger\n",60);
                            system("cls");
                            Sleep(750);
                            setSfondo(0);
                            cambiaColoreSfondo(0,15);
                    ...
                    if(u==1){//Scelta numero: 1.1.2.2.2.1
                        ...
                        if(v==1){//Scelta numero: 1.1.2.2.2.1.1
                            ...
                            else{//Scelta numero: 1.1.2.2.2.1.1.2
                                //dafinire
                            }
                        }
                        else{//Scelta numero: 1.1.2.2.2.1.2
                    ...
                    else{//Scelta numero:1.1.2.2.2.2
                        SetConsoleTextAttribute(hc, 0x70);
                        ...
                        print_slow(cout,"You run crossing a red light, a car honks at you\nYou feel so out of place doing this in the middle of the city\nBut at the same time this feels so relieving\nYou ran so much you're about to pass in front of the working place of a friend\n\n",45);
                        ...
                        if(w==1){//Scelta numero: 1.1.2.2.2.2.1
                            ...
                            mostraAsciiArt("faraway.ansi");
                            print_slow(cout,"You see all the faces of the people for a split second\nYou really don't know what to do next without a job\nYou just want to enjoy the moment\nThe dream becomes even more real when you realize you're almost out of town\nThe main color surrounding you now is the yellow of all the hay camps around the road\nThe sidewalk ends there's only a gray road with patches of wheat to the sides\n\n",37);
                            ...
                            if (chrono::duration_cast<chrono::seconds>(now - start).count() >= 6) {
                            cout << "1\n";
                            string fake = "1";
                            stringstream ss(fake);
                            ss >> aj;
                            goto label6;
                            }
                            }
                            if(aj==1){label6://Scelta numero: 1.1.2.2.2.2.1.1
                            ...
                            Sleep(500);
                            SetConsoleTextAttribute(hc, 0x78);
                            print_slow(cout,"\n-WAIT THIS IS CRAZY!\n-You're telling me that the biggest achievement in technology history just disappeared?\n",50);
                            Sleep(100);
                            SetConsoleTextAttribute(hc, 0x70);
                            ...
                            Sleep(150);
                            SetConsoleTextAttribute(hc, 0x7D);
                            print_slow(cout,"\n-yes, other than after we checked the CCTV footage we...\n",62);
                            Sleep(200);
        ...
        mostraAsciiArt("drive.ansi");
        Sleep(400);
        print_slow(cout,"\nSo you start walking to your car parked down the road\n\nWhere are you going?\n\n1)Go visit an old friend            2)Just drive around\n\n",55);
        d=cinBloccato();
        if(d==1){//Scelta numero: 1.2.1
            print_slow(cout,"\nYou remember Josh an old friend of yours\n",60);
            SetConsoleTextAttribute(hc, 0x78);
            print_slow(cout,"\n-I should totally go check him out\n",60);
            SetConsoleTextAttribute(hc, 0x70);
            print_slow(cout,"\nYou enter the car and calmly drive to his house\nA mid-range, average house in a not too good neighborhood near the forest\nYou park in front of it",60);
            mostraAsciiArt("joshc.ansi");
            print_slow(cout,"\nFlick the cigarette out of the window and walk to his porch\nYou ring the bell",60);
            Sleep(1750);
            print_slow(cout,"\n\nNo one answers\n\n1)Go somewhere else.            2)Peek the window.\n\n",60);
            e=cinBloccato();
            if(e==1){//Scelta numero: 1.2.1.1
                print_slow(cout,"\n\nYou don' wanna be too invasive,\nMaybe he's asleep or not in the house\nAnd also you don't want to say indoor again because\n",60);
                goto label3;
            }
            else{//Scelta numero: 1.2.1.2
                print_slow(cout,"\nYou silently approach the window\nJust to see the corpse of Josh lying on the sofa face down\n",60);
                Sleep(560);
                SetConsoleTextAttribute(hc, 0x78);
                print_slow(cout,"\n-That douchebag must be sleeping\n",60);
                Sleep(250);
                SetConsoleTextAttribute(hc, 0x70);
                ...
                if(h==1){//Scelta numero: 1.2.1.2.1
                    ...
                    if(eh==1){//Scelta numero: 1.2.1.2.2.1 La root giusta per aprire il basement
                        ...
                        if(aw==1){//Scelta numero: 1.2.1.2.2.1.1
                        ...
                        else{//Scelta numero: 1.2.1.2.2.1.2
                            print_slow(cout,"\nYou look at Josh, poor guy going through all that\nYou should cheer him a little up since you're here\nYou shout:\n",60);
                            SetConsoleTextAttribute(hc, 0x78);
                            print_slow(cout,"\n-Knock knock brother\n",50);
                            Sleep(500);
                            SetConsoleTextAttribute(hc, 0x70);
                            ...
                            else{//Scelta numero: 1.2.1.2.2.1.2.2 IL FINALE IN CUI MC RIESCE AD APRIRE LA cantina
                                Sleep(100);
                    ...
                    else{//Scelta numero: 1.2.1.2.2.2 
                        print_slow(cout,"\nYou stealthily take the note and start reading\n\n",60);
                        system("start https://drive.google.com/file/d/1aTSZNnLV8ATaMhYtNAZFofOvp5CdN3R_/view?usp=drive_link");
                        Sleep(22000);
                        ...
                        if(j==1){//Scelta numero: 1.2.1.2.2.2.1
                            ...
                            if(ao==1){//Scelta numero: 1.2.1.2.2.2.1.1
                                print_slow(cout,"\nYou look at the envelope on the left\nIt comes in a black envelope, unusual\nYou reach to open it and notice that it was already open\n",60);
                                Sleep(1000);
                                system("start https://drive.google.com/file/d/1Fx5Yc-MMVODA0rNOUfjAdmmLlFRMMaMk/view?usp=drive_link");
                                Sleep(30000);
                                print_slow(cout,"\nWow ok",60);
                            ...
                            else{//Scelta numero: 1.2.1.2.2.2.1.2
                                Sleep(100);
                                print_slow(cout,"\n\nYou look at the envelope on the right\nIt's white and clean with a weird knob\nYou carefully pull the glue away with your keys\nOnce opened you take the paper out and start reading\n",60);
                                system("start https://drive.google.com/file/d/1mz-0L6530hZ1Yf8nisLeDxrAQOs7VVEa/view?usp=drive_link");
                                Sleep(30000);
                                ...
                                Sleep(1000);
                                print_slow(cout,"\nThen Josh jumps on the couch beside you\n",60);
                                SetConsoleTextAttribute(hc, 0x79);
                                Sleep(400);
                                print_slow(cout,"\n-Hey pal ",40);
                                Sleep(600);
                                ...
                                if(bb==1){//Scelta numero: 1.2.1.2.2.X.X.X.1
                                    SetConsoleTextAttribute(hc, 0x78);
                                    print_slow(cout,"\n-You wanna go have some funn buddy?",52);
                                    Sleep(500);
                                    print_slow(cout,"\n-Cause i sure do\n",58);
                                    Sleep(750);
                                    SetConsoleTextAttribute(hc, 0x70);
                                    print_slow(cout,"\nJosh is looking at the floor with a look between desperate and zoned out",60);
                                    Sleep(550);
                                    print_slow(cout,"\nThen something inside him snaps,\nHe looks back at you with his usual face and smiles\n",60);
                                    Sleep(350);
                                    SetConsoleTextAttribute(hc, 0x79);
                                    print_slow(cout,"\n-You know what ",75);
                                    cout<<nome;
                                    print_slow(cout," you're right\n",55);
                                    Sleep(100);
                                    SetConsoleTextAttribute(hc, 0x70);
                                    print_slow(cout,"\nHe stands up seemingly full of energy\n",60);
                                    SetConsoleTextAttribute(hc, 0x79);
                                    print_slow(cout,"\n-Let's go have ",60);
                                    print_slow(cout,"SOME FUCKING FUN\n",45);
                                    Sleep(500);
                                    SetConsoleTextAttribute(hc, 0x70);
                                    print_slow(cout,"\nYou smile seeing the sudden switch in Josh's mood\nSo naturally you dap him up and start heading for the door\n",60);
                                    Sleep(350);
                                    SetConsoleTextAttribute(hc, 0x79);
                                    print_slow(cout,"\n-OH, hold on hold on\n",50);
                                    Sleep(250);
                                    SetConsoleTextAttribute(hc, 0x70);
                                    print_slow(cout,"\nJosh approaches the tv stand and pulls out a bottle of perfume\n",60);
                                    Sleep(120);
                                    SetConsoleTextAttribute(hc, 0x78);
                                    print_slow(cout,"\n-UU, someone's trying to be attractive\n",53);
                                    Sleep(260);
                                    SetConsoleTextAttribute(hc, 0x79);
                                    print_slow(cout,"\n-Yeah dude even tho i hate woman...\n",45);
                                    SetConsoleTextAttribute(hc, 0x70);
                                    print_slow(cout,"\nYeah Josh is an absolute misogynist\n",60);
                                    SetConsoleTextAttribute(hc, 0x79);
                                    print_slow(cout,"\n-...after Beth left i need to crack someone or ill'go nuts\n",48);
                                    Sleep(150);
                                    SetConsoleTextAttribute(hc, 0x78);
                                    print_slow(cout,"\n-That's what im here for bud\n",50);
                                    SetConsoleTextAttribute(hc, 0x70);
                                    print_slow(cout,"\nThis perfume smells like underground bunker\nYuck\n",60);
                                    Sleep(1300);
                                    print_slow(cout,"\nYou guys head to your car and start driving to the Night club of Taking over\nProbably yesterday's night is still going on\nYou love that club, so many memories\nJust the name of it makes you want to go there\nThe concept of taking over something excites you\nBut you need to start slow to grow bigger right\n",60);
                                    Sleep(450);
                                    SetConsoleTextAttribute(hc, 0x79);
                                    print_slow(cout,"\n-Dude you drive fast huh\n",56);
                                    Sleep(350);
                                    SetConsoleTextAttribute(hc, 0x78);
                                    print_slow(cout,"\n-Hoes don't wait for you dog\n",53);
                                    Sleep(500);
                                    SetConsoleTextAttribute(hc, 0x79);
                                    print_slow(cout,"\n-So wise bro\n",50);
                                    Sleep(1000);
                                    SetConsoleTextAttribute(hc, 0x70);
                                    print_slow(cout,"\nYou guys park in the club parking space and make your way inside the club\nOf course you bring your glovebox joint with you",60);
                                    //musica techno
                                    print_slow(cout,"\nThe place is still full of people\nSome drunk passed out on the sofas\nSome are making out in plain sight\nMost are vibing on the dance floor\n",60);
                                    SetConsoleTextAttribute(hc, 0x79);
                                    Sleep(200);
                                    print_slow(cout,"\n-Hell yeah",48);
                                    Sleep(750);
                                    SetConsoleTextAttribute(hc, 0x70);
                                    print_slow(cout,"\n\n1)Go get drunk         2)Go get high\n\n",60);
                                    bc=cinBloccato();
                                    if(bc==1){//Scelta numero: 1.2.1.2.2.X.X.X.1.1
                                        //finale felice in cui vai ad un festival con josh e si trova una piskella
                                        //dafinire
                                    }
                                    else{//Scelta numero: 1.2.1.2.2.X.X.X.1.2
                                        //alice ti vienea parlare mentre fumi
                                        //dafinire
                                    }
                                }
                                else{//Scelta numero: 1.2.1.2.2.X.X.X.2
                                    ...
                                    print_slow(cout,"\n-Right, right shit\n",40);
                                    SetConsoleTextAttribute(hc, 0x70);
                                    print_slow(cout,"\n while Josh calls the water guys you walk a little closer to the explosion site\nEven if it's smoking, on fire and dangerous\n",60);
                                    Sleep(750);
                            ...
                            Sleep(750);
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nYou both walk through the mess onto the couch\n",60);
                            Sleep(3000);
                            print_slow(cout,"He sits back on there you sit on the smaller leather chair\n",60);
                            Sleep(750);
                            SetConsoleTextAttribute(hc, 0x79);
                            print_slow(cout,"\n-Man sorry for the mess,\n-I've been throwing a lot of parties since me and Beth broke up\n",45);
                            Sleep(200);
                            SetConsoleTextAttribute(hc, 0x78);
                            ...
                            SetConsoleTextAttribute(hc, 0x70);
                            Sleep(750);
                            print_slow(cout,"\nHe stands up and you take out your phone and wait\n",60);
                            Sleep(4500);
                            goto label1;
                        }
                    }
            ...
            if(f==1){//Scelta numero: 1.2.2.1
                ...
                print_slow(cout,"\n-Jesus..\n",40);
                SetConsoleTextAttribute(hc, 0x70);
                print_slow(cout,"\nYou start going through your cd's to hear your thoughts a little less\n",60);
                Sleep(500);
                SetConsoleTextAttribute(hc, 0x78);
                ...
                SetConsoleTextAttribute(hc, 0x70);
                Sleep(750);
                print_slow(cout,"\nYou reach for the glovebox and open it\nInside other than the car insurance and a few papers there is\nSomething you care about more.\n",60);
                Sleep(500);
                ...
                if(ar==1){//Scelta numero: 1.2.2.1.1
                    ...
                    Sleep(1000);
                    print_slow(cout,"\nYou keep cruising thinking you really deserve a small break\nEven tho you kind of feel at fault about skipping work\n",60);
                    Sleep(500);
                    print_slow(cout,"\nYou kind of feel paranoid thinking about it\nThat place sends shivers down your spine sometimes\nNot only because its soulless nature bothers you\nBut thinking about how much time you spent in there\n",60);
                    Sleep(600);
                    ...
                    SetConsoleTextAttribute(hc, 0x78);
                    print_slow(cout,"\n-Fucking sun\n",48);
                    mostraAsciiArt("driveb.ansi");
                    SetConsoleTextAttribute(hc, 0x70);
                    print_slow(cout,"\nThe sun is shining in your eyes\nYou really hate it\nEven in your day to day life, the sun really bothers you,\n",60);
                    Sleep(500);
                    print_slow(cout,"\nYou reach for a pair of sunglasses in the glove box\n",60);
                    Sleep(400);
                    SetConsoleTextAttribute(hc, 0x78);
                    print_slow(cout,"\n-Much better\n",45);
                    SetConsoleTextAttribute(hc, 0x70);
                    Sleep(2000);
                    print_slow(cout,"\nAnd after a few minutes you're there.",60);
                    Sleep(400);
                    mostraAsciiArt("beachp.ansi");
                    print_slow(cout,"You park at the 'beach only' parking area\nIn one of the 4 free spaces\n",60);
                    Sleep(500);
                    SetConsoleTextAttribute(hc, 0x78);
                    print_slow(cout,"\n-What a nightmare",60);
                    Sleep(600);
                    print_slow(cout,"\n-Why are there so many people on a monday morning?\n",60);
                    Sleep(250);
                    PlaySound(TEXT("./music/FA.wav"), NULL, SND_FILENAME | SND_ASYNC | SND_LOOP);
                    SetConsoleTextAttribute(hc, 0x70);
                    print_slow(cout,"\nYou get out of the car with:\nNo umbrella\nNo beach towel\nNo deckchair\nAnd no will to live either\n",60);
                    Sleep(1200);
                    SetConsoleTextAttribute(hc, 0x78);
                    ...
                    Sleep(300);
                    print_slow(cout,"\nThe sand getting anywhere\nThe dirty water\nThe disgusting fishes\nAnd the fucking families\n",60);
                    Sleep(750);
                    print_slow(cout,"\nYou start walking from the parking place to the actual beach\nJust with your phone and sunglasses\n",60);
                    Sleep(400);
                    print_slow(cout,"\nWhile you walk you realize maybe why you came,\n",60);
                    Sleep(400);
                    print_slow(cout,"\nMaybe the fact that you enjoyed it as a kid was enough to come\nAll those little innocent memories\nFighting the waves until you were out of breath\nEating ice cream with your friends\nDigging huge holes\nWho knew that those moments would become happy memories\n",60);
                    Sleep(750);
                    print_slow(cout,"\nYou crack a smile\n",60);
                    Sleep(2000);
                    print_slow(cout,"\nYou reach the free beach entrance,\n",60);
                    mostraAsciiArt("beach.ansi");
                    Sleep(500);
                    ...
                    Sleep(500);
                    print_slow(cout,"\nThe sight of the clean shore with no annoying human is so delightful to you\nYou're so excited you don't even know what to do right now",60);
                    Sleep(350);
                    ...
                    if(av==1){//Scelta numero: 1.2.2.1.1.1
                        ...
                        Sleep(1500);
                        print_slow(cout,"\nFor your whole life you've felt detached from things\nYou've always paid little attention to the people and places around you\nAlways wanting to bend your future, to break the routine\n",60);
                        Sleep(1000);
                        print_slow(cout,"\nBut these little moments really make you wonder\nIs it even worth it living like this\nCaring about something that feels so unachievable\nChasing a goal so far away\nAnd ignoring all the beauty that's already around you all the time\n",60);
                        Sleep(2000);
                        SetConsoleTextAttribute(hc, 0x78);
                        print_slow(cout,"\n-Fuck\n",43);
                        SetConsoleTextAttribute(hc, 0x70);
                        Sleep(240);
                        print_slow(cout,"\nYou jump in the water fully clothed in a sort of dive\n",60);
                        setSfondo(0);
                        ...
                        print_slow(cout,"\nYou make it in time and take a deep breath once out\nYou drag your hair back,\nWipe the water out of your eyes and open them back\n",60);
                        mostraAsciiArt("whales.ansi");
                        Sleep(350);
                        SetConsoleTextAttribute(hc, 0x78);
                        print_slow(cout,"\n-Whoa what the hell?\n",48);
                        SetConsoleTextAttribute(hc, 0x70);
                        ...
                        print_slow(cout,"\n-De- ",70);
                        Sleep(100);
                        print_slow(cout,"Dead whales?",65);
                        Sleep(500);
                        print_slow(cout,"\n-Why?",55);
                        Sleep(100);
                        print_slow(cout,"\n-From where?\n",55);
                        ...
                        Sleep(800);
                        print_slow(cout,"\nLooking up you notice the sky filling with clouds\nThe opposite of what you read on the forecast\nEven tho the sun is covered the whale blood still reflects a golden light\n",60);
                        Sleep(1000);
                        print_slow(cout,"\nA low pitch fills your ears\nThe shadows of the clouds cast onto the beach and darken the atmosphere\nIt's colder now, feels like winter\n",60);
                        Sleep(1000);
                        ...
                        if(ay==1){//Scelta numero: 1.2.2.1.1.1.1
                        ...
                        else{//Scelta numero: 1.2.2.1.1.1.2
                            print_slow(cout,"\nYour stomach growls harder\nYou feel like you are losing control of your body\n",60);
                            Sleep(250);
                            SetConsoleTextAttribute(hc, 0x78);
                            print_slow(cout,"\n-No, im not like this\n",77);
                            Sleep(300);
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nYou rest your hand on your stomach in pain\nYou stare down at your feet and start walking away from the whales\n",60);
                            Sleep(200);
                            SetConsoleTextAttribute(hc, 0x78);
                            print_slow(cout,"\n-I need to get out now\n",67);
                            Sleep(700);
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nYour steps feel heavy",60);
                            Sleep(3500);
                            print_slow(cout,"\nYour head is pulsating",60);
                            Sleep(3500);
                            ...
                            print_slow(cout,"\n-C'mon",80);
                            Sleep(750);
                            print_slow(cout,", im not this weak\n",55);
                            Sleep(2000);
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nYou managed to walk away from the carcasses\nYour stomach growls once again\nThis time is something you can't contain\n",60);
                            Sleep(3000);
                            print_slow(cout,"\nYou put your hands over your knees and start throwing up\n",60);
                            Sleep(5000);
                            mostraAsciiArt("tar.ansi");
                            print_slow(cout,"\nA black dense liquid comes out of your mouth\n",60);
                            Sleep(300);
                            SetConsoleTextAttribute(hc, 0x78);
                            print_slow(cout,"\n-Fuck",80);
                            Sleep(200);
                            print_slow(cout,"\n-Am-",88);
                            print_slow(cout," am i dying?\n",50);
                            Sleep(800);
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nYou look up and see that the parking lot is gone",60);
                            mostraAsciiArt("sand.ansi");
                            print_slow(cout,"\nNow it's just sand as far as the eye can see\n",60);
                            Sleep(1000);
                            setSfondo(0);
                            print_slow(cout,"\nYour eyes instinctively close in disbelief\n",60);
                            Sleep(1400);
                            SetConsoleTextAttribute(hc, 0x72);
                            print_slow(cout,"\n-You are about to",66);
                            Sleep(750);
                            mostraAsciiArt("sandl.ansi");
                            print_slow(cout,"\n-But it might relieve you to know that you can't die in here\n",55);
                            Sleep(250);
                            SetConsoleTextAttribute(hc, 0x70);
                            ...
                            Sleep(340);
                            SetConsoleTextAttribute(hc, 0x72);
                            print_slow(cout,"\n-That i cannot answer.",46);
                            Sleep(600);
                            print_slow(cout,"\n-What i can tell you is that you're different from everyone else",50);
                            Sleep(1000);
                            print_slow(cout,"\n-You don't belong here and...\n-Let's say we need you where you belong again\n",55);
                            Sleep(800);
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nYou stare at her still in pain\n",60);
                            SetConsoleTextAttribute(hc, 0x72);
                            print_slow(cout,"\n-All this suffering,",70);
                            Sleep(750);
                            print_slow(cout,"\n-Just a bare reminder of who you are and where you come from\n",60);
                            Sleep(300);
                            SetConsoleTextAttribute(hc, 0x78);
                            print_slow(cout,"\n-OK BUT WHY ME",47);
                            Sleep(450);
                            ...
                            Sleep(500);
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nYou can almost feel her cold gaze through her sunglasses\n",60);
                            Sleep(500);
                            SetConsoleTextAttribute(hc, 0x72);
                            print_slow(cout,"\n-I think i already told you everything i needed to.\n",60);
                            Sleep(250);
                            mostraAsciiArt("gungirl.ansi");
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nHer right arm is pointing at you\nShe has a gun in her hand\n",60);
                            Sleep(750);
                            SetConsoleTextAttribute(hc, 0x78);
                            print_slow(cout,"\n-uh WAIT",77);
                            PlaySound(TEXT("./music/gun.wav"), NULL, SND_SYNC );
                            system("cls");
                            cambiaColoreSfondo(0,15);
                            setSfondo(0);
                            for (int i = 0; i <= total; ++i) {
                    ...
                    else{//Scelta numero: 1.2.2.1.1.2
                        print_slow(cout,"\nYou lay on the soft sand\nIt's not as bad as you remembered\n",60);
                        Sleep(350);
                    ...
                    if(ba==1){//Scelta numero: 1.2.2.1.2.1
                        ...
                        Sleep(350);
                        print_slow(cout,"\nYou immediately feel the tires losing grip from the asphalt, fuck your past self for not inflating them properly\n",50);
                        Sleep(10);
                        ...
                        std::cout << "\033[H";
                        Sleep(50);
                        print_slow(cout,"\nYou were really hoping for someone to come and rescue you but no luck,\nYou get out from the only possible door climbing the seats\n",60);
                        Sleep(1200);
                        ...
                        SetConsoleTextAttribute(hc, 0x78);
                        Sleep(300);
                        print_slow(cout,"\nShe raises her tone in anger before taking a deep breath mid sentence and then rephrase it\n",60);
                        Sleep(1000);
                        SetConsoleTextAttribute(hc, 0x72);
                        ...
                        Sleep(750);
                        SetConsoleTextAttribute(hc, 0x70);
                        print_slow(cout,"\nHow does she know i was going to the airport?\nFuck i gotta call a tow truck\n",60);
                        SetConsoleTextAttribute(hc, 0x78);
                        ...
                        SetConsoleTextAttribute(hc, 0x70);
                        Sleep(200);
                        print_slow(cout,"\nYou are almost face to face with her\nThis is weird\nShe lowers her shades a little showing her dark black eyes\nThen she whispers\n",60);
                        Sleep(750);
                        SetConsoleTextAttribute(hc, 0x72);
                    ...
                    else{//Scelta numero: 1.2.2.1.2.2
                        //finale in cui arrivi all'aereoporto e in realta' e' finto tipo cartonato 
                        //dafinire
                    }
                }
            }
            else{//Scelta numero: 1.2.2.2
                /*aggiungrere una mappa dall'alto della foresta per evitare di rifare tutta la citta innevata in ascii
                far addressare questo ai pensieri del personaggio dicendo che siccome la mamma era preoccupata gli ha dato una mappa che ha nella 24h*/
                SetConsoleTextAttribute(hc, 0x78);
                ...
                Sleep(750);
                print_slow(cout,"\nYou ever barely visited this forest as a kid, your mom was always worried you could get lost\nShe even gave you a map you keep with you in your bag\nYou hope you won't need it\nBut you get why now, This forest is huge.\n",60);
                Sleep(1000);
                print_slow(cout,"\nYou walk for about 15' in a straight line,\nBut from the surroundings it almost looks like you haven't moved at all\nIt's always tall dark trees on a soft humid ground\n",60);
                Sleep(1000);
                print_slow(cout,"\nAs you keep walking you stumble upon something weird none the less\nOn your right there is a set of stairs coming out the ground, seemingly leading to nothing,\n",45);
                mostraAsciiArt("stairs.ansi");
                Sleep(2000);
                print_slow(cout,"\nThat look so out of place, You curiously walk up to them\nStepping on them you start feeling them\nJust plain metal stairs,\nWhy would you build in a forest something that looks straight out of an office\n\n1)See where they lead          2)Run away\n\n",60);
                s=cinBloccato();
                if(s==1){//Scelta numero: 1.2.2.2.1
                    mostraAsciiArt("lotstairs.ansi");
                    ...
                    if(k==1){//Scelta numero: 1.2.2.2.1.1
                        ...
                        print_slow(cout,"\nYou press it.",60);
                        Sleep(2000);
                        mostraAsciiArt("generatoron.ansi");
                        cambiaColoreSfondo(7,0);
                        Sleep(750);
                        ...
                        if(a==1){//Scelta numero: 1.2.2.2.1.1.1
                            ...
                            Sleep(750);
                            mostraAsciiArt("leftroom.ansi");
                            print_slow(cout,"\nIt looks like a woman from the hair and the breast\nShe's dressed like a corpo employee all black\nA headset covers half of her face is also the source of the light\nShe's sitting on what looks like an old dentist chair\n",60);
                            Sleep(500);
                            ...
                            Sleep(1500);
                            PlaySound(NULL, 0, 0);
                            MessageBox(NULL,"You were disconnected, Awaiting for lenny to respond and reconnect","This program encountered a fatal error!", MB_ICONERROR | MB_OK | MB_TOPMOST | MB_SYSTEMMODAL);
                            exit(0);
                        }
                        else{//Scelta numero: 1.2.2.2.1.1.2
                    ...
                    else{//Scelta numero: 1.2.2.2.1.2
                        SetConsoleTextAttribute(hc, 0x78);
                        print_slow(cout,"\n-Nah im done with this\n",55);
                        SetConsoleTextAttribute(hc, 0x70);
                        print_slow(cout,"\nThe echo of your steps stops through the walls of packed dirt surrounding you\n",60);
                        SetConsoleTextAttribute(hc, 0x78);
                        print_slow(cout,"\n-What am i even doing\n",55);
                        SetConsoleTextAttribute(hc, 0x70);
                        print_slow(cout,"\nYou start walking back up watching out to not hit your head\nThe tunnel is not too tall but you still try hurry up\n",60);
                        Sleep(600);
                        print_slow(cout,"\nAs the steps gets louder you notice something\nThe little tunnel you're walking in\nIt's changing the more up you go\n",60);
                        mostraAsciiArt("stairsup.ansi");
                        Sleep(500);
                        print_slow(cout,"The walls transition from dirty gray bricks to clean red ones\nThe roof becomes of a white plastic\nOnly the stairs stays the same\nA little later and lights start appearing on the ceiling too\n",60);
                        Sleep(500);
                        SetConsoleTextAttribute(hc, 0x78);
                        print_slow(cout,"\n-It looks like...\n",60);
                        Sleep(200);
                        print_slow(cout,"\nLight seeps at the end of the tunnel\nYou see the exit,",60);
                        Sleep(360);
                        print_slow(cout,"\nThe entrance?\n",60);
                        Sleep(150);
                        SetConsoleTextAttribute(hc, 0x78);
                        ...
                        Sleep(400);
                        SetConsoleTextAttribute(hc, 0x70);
                        print_slow(cout,"\nYou take the last step and are finally out\n",60);
                        mostraAsciiArt("trainst.ansi");
                        Sleep(550);
                        print_slow(cout,"\nThe forest is gone\n",60);
                        SetConsoleTextAttribute(hc, 0x78);
                        print_slow(cout,"\n-Wonderful\n",50);
                        Sleep(250);
                        SetConsoleTextAttribute(hc, 0x70);
                        print_slow(cout,"\nInstead a clearly abandoned train station sits in front of you\n",60);
                        SetConsoleTextAttribute(hc, 0x78);
                        print_slow(cout,"\n-Just lovely\n",55);
                        Sleep(450);
                        SetConsoleTextAttribute(hc, 0x70);
                        print_slow(cout,"\nLooking around the first thing you see is a rusty train\nPlants started growing on the tracks and walls\nYou smell mold in the air, and overall the place smells old\n",60);
                        Sleep(300);
                        SetConsoleTextAttribute(hc, 0x78);
                        print_slow(cout,"\n-This doesn't make any sense at all",48);
                        Sleep(1000);
                        print_slow(cout,"\n-What the fuck am i supposed to do in here\n",44);
                        Sleep(450);
                        SetConsoleTextAttribute(hc, 0x70);
                        print_slow(cout,"\nThe whole place is shaped like a hollow rectangle,\nThe walls where the train comes in and out are\nCompletely gone allowing you to see outside\nYou see the sky letting in a bit of sunlight\n",60);
                        Sleep(150);
                        print_slow(cout,"\n\n1)Get a closer look            2)Get on the train",60);
                        bd=cinBloccato();
                        if(bd==1){//Scelta numero: 1.2.2.2.1.2.1
                            //si va sul bordo della stazione e vedi la citta sotto
                            //trovi la lettera di alice persa
                            //root che si spezza se la hai gia incontrata
                            print_slow(cout,"\nYou walk towards the end of station\nThe ground squeaks with every step\nYou can make out what seem to be ads under the moss\nWith some catchphrases like\n",60);
                            SetConsoleTextAttribute(hc, 0x78);
                            Sleep(200);
                            print_slow(cout,"\n-Discover a new world?",55);
                            Sleep(750);
                            print_slow(cout,"\n-This is weird\n",48);
                            Sleep(520);
                            SetConsoleTextAttribute(hc, 0x70);
                            print_slow(cout,"\nApproaching the edge you can feel the wind blowing at a speed you never felt before\nYou step close enough to look down\n",60);
                        }
                        else{//Scelta numero: 1.2.2.2.1.2.2
                            //root in cui puoi segliere se andare avanti o indietro
                            //se vai indietro incontri lenny all'entrata del mondo
                        }
                    }
                }
                else{//Scelta numero: 1.2.2.2.2
                    PlaySound(TEXT("./music/WH.wav"), NULL, SND_FILENAME | SND_ASYNC);
                    print_slow(cout,"\nThese stairs make you tense,\nYou start backing from them while still keeping an eye on\n",60);
                    Sleep(1500);
                    print_slow(cout,"\nYou hear faint whispers in the air,\nSomething was definitely wrong with those stairs\nYou start walking a little bit faster trying to get away from the strange noises\n",60);
                    PlaySound(TEXT("./music/414.wav"), NULL, SND_FILENAME | SND_ASYNC );
                    Sleep(1500);
                    print_slow(cout,"\nYou still wanna visit the forest but don't wanna get in danger with stuff like that\nAs you keep walking your heavy and crusty lungs start filling with fresh air\nThe air is getting colder, the deep dark woods start to get a little more colourful\nA pinkish light seeps through the leaves\n",60);
                    Sleep(500);
                    SetConsoleTextAttribute(hc, 0x78);
                    print_slow(cout,"\n-Is that ..",54);
                    Sleep(200);
                    ...
                    if(ai==1){//Scelta numero: 1.2.2.2.2.1
                        ...
                        Sleep(500);
                        print_slow(cout,"\nWeirdly through the glass you notice there is no one inside so you just walk around the bar\n",60);
                        Sleep(450);
                        ...
                        Sleep(10000);
                        print_slow(cout,"It's getting cold in here\nAt this point you just gotta push through and see where you end up\n",60);
                        Sleep(750);
                        print_slow(cout,"\nYou see minimarkets with no door\nCold abandoned vegetable stands\nMostly homes with no more than 2 floors\n",60);
                        Sleep(340);
                        SetConsoleTextAttribute(hc, 0x78);
                        ...
                        ap=cinBloccato();
                        if(ap==1){
                            print_slow(cout,"You're looking for some nice cool place to explore",60);
                            //dafinire
                        }
                        else{
                            //dafinire
                    ...
                    else{//Scelta numero: 1.2.2.2.2.2
